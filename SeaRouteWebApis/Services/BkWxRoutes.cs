...
//    public void ProcessWaveData(string sessionFolderPath, string waveData)
//    {
...
//                                    Wxroute(1, FILENAME, IANALYSIS_TYPE);
//                                if (IFLAG_TRAN == 1 && SAVEFLG[1] == '1')
//                                    Wxroute(2, FILENAME, IANALYSIS_TYPE);
//                                if (IFLAG_HSTE == 1 && SAVEFLG[2] == '1')
//                                    Wxroute(3, FILENAME, IANALYSIS_TYPE);
//                                if (IFLAG_HRTE == 1 && SAVEFLG[3] == '1')
//                                    Wxroute(4, FILENAME, IANALYSIS_TYPE);
//                            }
//                        }
//                        PRintWSDS(WOKDIR);
//                    }
...
//    {
//        if (IFLAG_ISTE == 1 && SAVEFLG[0] == '1') Wxroute(1, FILENAME, IANALYSIS_TYPE);
//        if (IFLAG_TRAN == 1 && SAVEFLG[1] == '1') Wxroute(2, FILENAME, IANALYSIS_TYPE);
//        if (IFLAG_HSTE == 1 && SAVEFLG[2] == '1') Wxroute(3, FILENAME, IANALYSIS_TYPE);
//        if (IFLAG_HRTE == 1 && SAVEFLG[3] == '1') Wxroute(4, FILENAME, IANALYSIS_TYPE);
//    }

//    private void Wxroute(int IFIELD, string FILENAME, int IANALYSIS_TYPE)
//    {
...
//                {
//                    ProcessFile(IFIELD, IANALYSIS_TYPE);
//                }
//            }
//        }
//        catch (Exception ex)
...
//    private void ProcessFile(int IFIELD, int IANALYSIS_TYPE)
//    {
...
//        {
//            ProcessSiteData(IFIELD, IANALYSIS_TYPE);
//        }
//        else if (IFIELD == 2 || IFIELD == 4)
//        {
//            ProcessRouteData(IFIELD, IANALYSIS_TYPE);
//        }
//    }

//    private void ProcessSiteData(int IFIELD, int IANALYSIS_TYPE)
//    {
//        float ZERO = 0.0f;
//        FSBW26.Write(JUNK);
//        FSBW26.Write(ZERO);
...
//        {
//            // WXSITE(IFIELD, IANALYSIS_TYPE, ISITE, NSITE);
//        }
//    }

//    private void ProcessRouteData(int IFIELD, int IANALYSIS_TYPE)
//    {
//        if (IFIELD == 2) NWSD_TOTAL_TRANSIT = 0;
//        WXROUT(IFIELD, IANALYSIS_TYPE);
//    }

//    private void WXROUT(int IFIELD, int IANALYSIS_TYPE)
//    {
//        if (WAVETYPE == "ABS")
...
//        WxRouteFileOperations(IFIELD, IANALYSIS_TYPE);


//    }

//    private void WxRouteFileOperations(int IFIELD, int IANALYSIS_TYPE)
//    {
...
//                RouteWSDs(IFIELD, IROUTE, ROUTE_NAME, NPT, INBOUND, TIMEIDLE_PERCENTAGE, RETURN_PERIOD, YEAR, IFLAG_WAVEDIR, IBAND, IWEIGHTING_GRID);
...
//    public void RouteWSDs(int IFIELD, int iroute, string routeName, int NPT, float inbound, float TIMEIDLE_PERCENTAGE, float returnPeriod, float year, int iflagWaveDir, int iband, int iweightingGrid)
//    {
...
//                    if (WAVETYPE == "ABS")
//                        FILE15 = SYSDIR.Trim() + "abswave.ros";
//                    else if (WAVETYPE == "BMT")
//                        FILE15 = SYSDIR.Trim() + "bmtwave.ros";
//                    using (FSR15 = FileIO.GetFileStreamReader(FILE15, FileMode.Open))
//                    {
//                        for (int i = 0; i < NGRID; i++)
//                        {
...
//                    else if (WAVETYPE == "BMT")
//                        FILE15 = SYSDIR.Trim() + "bmtwave.sct";
