// Complete screenshot utilities for maps and charts

// Capture map as base64 string
window.captureMapAsBase64 = async (mapElementId) => {
    try {
...
// Capture chart as base64 string
window.captureChartAsBase64 = async (chartId) => {
    try {
        ...
        // If it's a Chart.js canvas, get it directly
...
// Enhanced map capture with routes (your existing function with fixes)
window.captureMapWithRoutes = async (mapElementId, displayElementId) => {
    try {
        ...
        // Display the image if displayElementId is provided
        if (displayElementId) {
            ...
            if (displayElement) {
                ...
                // Optional: show full image on click
...
// Capture any element as base64
window.captureElementAsBase64 = async (elementId) => {
    try {
